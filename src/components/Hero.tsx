    ...
    <section className="min-h-screen flex items-center relative overflow-hidden pt-20 px-6 lg:px-20">
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className={`text-lg lg:text-xl leading-relaxed mb-8 max-w-xl font-medium transition-colors mx-auto lg:mx-0 ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
          ...
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
            <a 
              href="#projects" 
              className={`px-8 py-4 rounded-xl font-bold transition-all flex items-center gap-2 group ${
                isDarkMode 
                  ? 'bg-white text-zinc-950 hover:bg-zinc-200' 
                  : 'bg-zinc-950 text-white hover:bg-zinc-800 shadow-xl shadow-indigo-500/10'
              }`}
            >
              View My Work
